...
Look in [LSCSCompat\items]([url](https://github.com/Solace140/Helix-LSCS-Compat/tree/main/LSCSCompat/items)) for examples itemizing force abilities, lightsaber hilts and lightsaber crystals.
